...
window.location.pathname='/admin/AllUsers'
  ...
  return (
    ...
    <Modal.Header >
        <Modal.Title> <div className='font'>  changer le Rôle</div></Modal.Title>
    </Modal.Header>
...
<button   className="btn-save d-inline mt-1 " onClick={ediite} >  Rôle </button> 
...
<button   className="btn-save d-inline mt-1 " onClick={deletee} > Supprimer </button> 
